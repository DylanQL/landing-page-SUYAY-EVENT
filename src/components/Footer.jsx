      ...
      <div className="footer-container">
        <div className="footer-grid">
          ...
          <div className="footer-brand">
            <div className="footer-logo">
              <img src="/Logo_sin_fondo-suyay.png" alt="Suyay Events Logo" className="logo-image" />
              <h2 className="logo-text">
                SUYAY EVENTS
              </h2>
            </div>
            <p className="footer-description">
              Conectamos personas con experiencias inolvidables. Nuestra plataforma 
              te ayuda a descubrir, organizar y disfrutar de los mejores eventos.
            </p>
        ...
        <div className="footer-bottom">
          <p className="copyright">
            © {new Date().getFullYear()} Suyay Events. Todos los derechos reservados.
          </p>
